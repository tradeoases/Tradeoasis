...
urlpatterns = [
    ...
    path('dashboard/contractsdetails/<int:pk>', views.DashboardContractsDetailsView.as_view(), name='dashboard-contractsdetails'),

    path('dashboard/services', views.DashboardServicesView.as_view(), name='dashboard-services'),
    path('dashboard/servicescreate', views.DashboardServicesCreateView.as_view(), name='dashboard-servicescreate'),
]
