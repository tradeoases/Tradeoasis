...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='service',
            name='price_de',
            field=models.DecimalField(decimal_places=2, max_digits=122, null=True, verbose_name='Price'),
        ),
        migrations.AddField(
            model_name='store',
            name='name_de',
            field=models.CharField(max_length=256, null=True, verbose_name='Store Name'),
        ),
    ]
