...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('PENDING', 'PENDING'), ('VIEWED BY SUPPLER', 'VIEWED BY SUPPLER'), ('ACCEPTED BY SUPPLER', 'ACCEPTED BY SUPPLER'), ('IN DELIVERY', 'IN DELIVERY'), ('DELIVERED', 'DELIVERED'), ('REJECTED', 'REJECTED'), ('COMPLETED', 'COMPLETED')], default='PENDING', max_length=256, verbose_name='Order Status')),
                ('currency', models.CharField(max_length=6, verbose_name='Currency')),
                ('agreed_price', models.DecimalField(decimal_places=2, max_digits=12, verbose_name='Agreed Price')),
                ('paid_price', models.DecimalField(decimal_places=2, max_digits=12, verbose_name='Agreed Price')),
                ...
                ('delivery_data', models.DateField(blank=True, null=True, verbose_name='Delivery Date')),
                ('created_on', models.DateField(default=django.utils.timezone.now, verbose_name='Created on')),
                ('business', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth_app.clientprofile')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='supplier.product')),
            ],
