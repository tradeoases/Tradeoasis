    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='/home/mugisa/Desktop/Tradeoasis/media/test/django.png', upload_to=supplier.models.get_file_path, verbose_name='Image')),
                ('slug', models.SlugField(blank=True, null=True, unique=True, verbose_name='Safe Url')),
                ('created_on', models.DateField(default=django.utils.timezone.now, verbose_name='Created on')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(blank=True, null=True, unique=True, verbose_name='Safe Url')),
                ('image', models.ImageField(default='/home/mugisa/Desktop/Tradeoasis/media/test/django.png', upload_to=supplier.models.get_file_path, verbose_name='Service Image')),
                ('created_on', models.DateField(default=django.utils.timezone.now, verbose_name='Created on')),
        ...
        migrations.AddField(
            model_name='product',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='supplier.productcategory'),
        ),
        migrations.AddField(
            model_name='product',
            name='store',
