    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paypal_id', models.CharField(blank=True, max_length=256, null=True, verbose_name='Trial Period')),
            ],
        ),
        migrations.CreateModel(
            name='Membership',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_type', models.CharField(blank=True, choices=[('SHOWROOMS', 'SHOWROOMS'), ('LOCAL', 'LOCAL')], max_length=256, null=True, verbose_name='Type')),
            ],
            options={
                'abstract': False,
            },
