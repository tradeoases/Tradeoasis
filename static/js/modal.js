    ...
    static build(product) {
        ...
        template.innerHTML = `
            ...
            <div class="modal-body">
                <div class="edit-form">
                    <form action="">
                        <div class="" style="position:relative;z-index:5;height:auto;width:fit-content;">
                            <div
                                style="background-color:#fff;padding:0 .2rem;width:fit-content;height:auto;position:absolute;z-index:10;top:1%;left:0%;transform: translate(50%, -50%);">
                                <h3 class="flex" style="margin:0;">Product Details</h3>
                            </div>
                            <div class="product-name-category"
                                style="justify-content:flex-start;height:fit-content;border:1px solid rgb(238, 234, 234);border-radius:0;padding:.8rem .6rem;">
                        ...
                        <div class="" style="position:relative;z-index:5;height:auto;width:100%;margin-top:1.6rem;">
                            <div
                                style="background-color:#fff;padding:0 .2rem;width:fit-content;height:auto;position:absolute;z-index:10;top:1%;left:0%;transform: translate(50%, -50%);">
                                <h3 class="flex" style="margin:0;">Product Images</h3>
                            </div>
                            <div class="product-name-category"
                                style="justify-content:flex-start;height:fit-content;border:1px solid rgb(238, 234, 234);border-radius:0;padding:.8rem .6rem;width:100%;">
